...
//			+ " FOREIGN KEY(" + Item.ITEM_CATEGORY_ID +") REFERENCES ITEM_CATEGORY(ID))";
	...
	public static final String upgradeTableSchema =
			"ALTER TABLE IF EXISTS " + Item.TABLE_NAME
					...
					+ " ADD COLUMN IF NOT EXISTS " + Item.VERSION + " int,"
	...
	protected Item(Parcel in) {
		...
		listPrice = in.readFloat();
		barcode = in.readString();
		barcodeFormat = in.readString();
		imageCopyrights = in.readString();
		gidbItemID = in.readInt();
		gidbServiceURL = in.readString();
		version = in.readInt();
	...
	public void writeToParcel(Parcel dest, int flags) {
		...
		dest.writeFloat(listPrice);
		dest.writeString(barcode);
		dest.writeString(barcodeFormat);
		dest.writeString(imageCopyrights);
		dest.writeInt(gidbItemID);
		dest.writeString(gidbServiceURL);
