package org.nearbyshops.shopkeeperapp.HomeDeliveryInventoryDeliveryGuy.PendingReturnCancelledByUser;
...
public class PendingReturnCancelledByUserDGI extends Fragment implements SwipeRefreshLayout.OnRefreshListener, AdapterPendingReturnCancelledByUserDGI.NotifyAcceptReturn ,NotifySearch,NotifySort{
...
//    OrderService orderService;
    ...
    AdapterPendingReturnCancelledByUserDGI adapter;
    ...
    public PendingReturnCancelledByUserDGI() {
     ...
     * number.
     */
    public static PendingReturnCancelledByUserDGI newInstance() {
        PendingReturnCancelledByUserDGI fragment = new PendingReturnCancelledByUserDGI();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_pending_return_cancelled_by_user_dgi, container, false);
    ...
    void setupRecyclerView()
    {
        ...
        adapter = new AdapterPendingReturnCancelledByUserDGI(dataset,this);
...
//                        null,limit,offset,null);
        ...
        Call<OrderEndPoint> call = orderServiceShopStaff.getOrders(
                ...
                null,null,false,
                OrderStatusHomeDelivery.CANCELLED_BY_USER_RETURN_PENDING,null,
...
//        Call<ResponseBody> call = orderService.putOrder(order.getOrderID(),order);
        ...
        Call<ResponseBody> call = orderServiceShopStaff.acceptReturnCancelledByUser(
                UtilityLogin.getAuthorizationHeaders(getActivity()),
                order.getOrderID()
        );
