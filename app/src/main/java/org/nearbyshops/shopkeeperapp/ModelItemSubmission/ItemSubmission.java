package org.nearbyshops.shopkeeperapp.ModelItemSubmission;
...
public class ItemSubmission {
    ...
    public static final String createTableItemSubmissionPostgres = "CREATE TABLE IF NOT EXISTS "
            ...
            + " FOREIGN KEY(" + ItemSubmission.ITEM_ID +") REFERENCES " + Item.TABLE_NAME + "(" + Item.ITEM_ID + "),"
            + " FOREIGN KEY(" + ItemSubmission.ITEM_CATEGORY_ID +") REFERENCES " + ItemCategory.TABLE_NAME + "(" + ItemCategory.ITEM_CATEGORY_ID + ")"
            + ")";
