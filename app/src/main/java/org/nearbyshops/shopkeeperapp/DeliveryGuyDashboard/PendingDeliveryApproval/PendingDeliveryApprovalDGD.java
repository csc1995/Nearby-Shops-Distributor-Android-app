...
public class PendingDeliveryApprovalDGD extends Fragment
        implements SwipeRefreshLayout.OnRefreshListener, NotifySearch,NotifySort{
...
//    NotificationReceiver notificationReceiver;
    ...
    public PendingDeliveryApprovalDGD() {
     ...
     * number.
     */
    public static PendingDeliveryApprovalDGD newInstance() {
        PendingDeliveryApprovalDGD fragment = new PendingDeliveryApprovalDGD();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_pending_delivery_approval_dgd, container, false);
