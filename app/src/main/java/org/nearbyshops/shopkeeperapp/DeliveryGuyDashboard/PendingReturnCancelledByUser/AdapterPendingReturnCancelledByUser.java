package org.nearbyshops.shopkeeperapp.DeliveryGuyDashboard.PendingReturnCancelledByUser;
 ...
 */
class AdapterPendingReturnCancelledByUser extends RecyclerView.Adapter<AdapterPendingReturnCancelledByUser.ViewHolder>{
    ...
    AdapterPendingReturnCancelledByUser(List<Order> dataset) {
        this.dataset = dataset;
//        this.notifications = notifications;
    }

    @Override
    public AdapterPendingReturnCancelledByUser.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_item_pending_return_cancelled_by_user,parent,false);

        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(AdapterPendingReturnCancelledByUser.ViewHolder holder, int position) {
