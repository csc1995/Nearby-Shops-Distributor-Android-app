package org.nearbyshops.shopkeeperapp.DeliveryGuyDashboard.PendingReturnCancelledByShop;
...
//    OrderService orderService;
    ...
    AdapterPendingReturnCancelledByShop adapter;
    ...
    public PendingReturnCancelledByShop() {
     ...
     * number.
     */
    public static PendingReturnCancelledByShop newInstance() {
        PendingReturnCancelledByShop fragment = new PendingReturnCancelledByShop();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_pending_return_cancelled_by_shop, container, false);
...
//        }
    ...
    void setupRecyclerView()
    {
        ...
        adapter = new AdapterPendingReturnCancelledByShop(dataset);
...
//                        null,limit,offset,null);
        ...
        Call<OrderEndPoint> call = orderServiceDelivery
                .getOrders(UtilityLogin.getAuthorizationHeaders(getActivity()),
                        deliveryGuyID,
                        null,null,
                        false,OrderStatusHomeDelivery.CANCELLED_BY_SHOP_RETURN_PENDING,
                        null,
                        null,null,
                        null,null,
                        null,
