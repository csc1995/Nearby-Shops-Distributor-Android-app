...
import org.nearbyshops.shopkeeperapp.ModelServiceConfig.ServiceConfigurationGlobal;
...
public class SlidingLayerSortServices extends Fragment {
    ...
    @Bind(R.id.sort_service_range) TextView sort_by_service_range;
    @Bind(R.id.sort_created) TextView sort_by_created;
    @Bind(R.id.updated) TextView sort_by_updated;
    @Bind(R.id.service_name) TextView sort_by_service_name;


    @Bind(R.id.sort_ascending) TextView sort_ascending;
    @Bind(R.id.sort_descending) TextView sort_descending;

    @Bind(R.id.filter_official) TextView filterOfficial;
    @Bind(R.id.filter_verified) TextView filterVerified;

    @Bind(R.id.filter_nonprofit) TextView filterNonprofit;
    @Bind(R.id.filter_government) TextView filterGovernment;
    @Bind(R.id.filter_commertial) TextView filterCommertial;
