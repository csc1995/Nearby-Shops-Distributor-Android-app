...
public class EditDeliverySelfFragment extends Fragment {
...
//    @Bind(R.id.govt_id_number) EditText govtIDNumber;
    ...
    public EditDeliverySelfFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.content_edit_self_delivery, container, false);
...
//            deliveryGuySelf = getActivity().getIntent().getParcelableExtra(DELIVERY_GUY_INTENT_KEY);
            deliveryGuySelf = UtilityLogin.getDeliveryGuySelf(getActivity());
...
//        deliveryGuySelf.setGovtIDNumber(govtIDNumber.getText().toString());
    ...
    public void retrofitPUTRequest()
    {
        ...
        // update Item Call
        Call<ResponseBody> call = deliveryService.updateBySelf(
        ...
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                if(response.code()==200)
                {
                    ...
                    UtilityLogin.saveDeliveryGuySelf(deliveryGuySelf,getActivity());
                    UtilityLogin.saveCredentials(getActivity(),deliveryGuySelf.getUsername(),deliveryGuySelf.getPassword());
                }
                else
                {
                    showToastMessage("Update Failed Code!" + String.valueOf(response.body()));
                }
