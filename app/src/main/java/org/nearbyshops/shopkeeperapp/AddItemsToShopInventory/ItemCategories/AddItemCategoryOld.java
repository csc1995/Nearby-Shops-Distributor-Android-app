...
public class AddItemCategoryOld extends AppCompatActivity implements Callback<Image>, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_item_category_old);
