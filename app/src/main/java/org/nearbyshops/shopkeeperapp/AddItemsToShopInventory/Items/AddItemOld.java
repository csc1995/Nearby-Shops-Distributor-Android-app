...
public class AddItemOld extends AppCompatActivity implements Callback<Image> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_item_old);
        ...
        itemCategory = getIntent().getParcelableExtra(ItemRemakeFragmentOld.ADD_ITEM_INTENT_KEY);
