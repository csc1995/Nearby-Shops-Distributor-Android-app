package org.nearbyshops.shopkeeperapp.AddItemsToShopInventory.ItemCategories;
...
public class ItemCategoriesAdapterOld extends RecyclerView.Adapter<ItemCategoriesAdapterOld.ViewHolder>{
    ...
    Context context;
    ItemCategoriesFragmentOld activity;
    ...
    public ItemCategoriesAdapterOld(List<ItemCategory> dataset, Context context, ItemCategoriesFragmentOld activity, ReceiveNotificationsFromAdapter notificationReceiver) {
    ...
    @Override
    public ItemCategoriesAdapterOld.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_item_category_old,parent,false);
    ...
    @Override
    public void onBindViewHolder(ItemCategoriesAdapterOld.ViewHolder holder, final int position) {
