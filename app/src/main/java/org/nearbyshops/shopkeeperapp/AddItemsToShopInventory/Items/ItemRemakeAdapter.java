...
public class ItemRemakeAdapter extends RecyclerView.Adapter<ItemRemakeAdapter.ViewHolder>{
    ...
    @Override
    public ItemRemakeAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(ItemRemakeAdapter.ViewHolder holder, final int position) {
