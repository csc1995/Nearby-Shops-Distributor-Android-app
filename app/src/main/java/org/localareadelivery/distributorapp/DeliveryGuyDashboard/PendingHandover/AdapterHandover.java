 ...
 */
public class AdapterHandover extends RecyclerView.Adapter<AdapterHandover.ViewHolder>{
    ...
    @Override
    public AdapterHandover.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(AdapterHandover.ViewHolder holder, int position) {
