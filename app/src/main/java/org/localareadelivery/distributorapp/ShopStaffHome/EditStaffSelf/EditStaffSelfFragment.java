package org.localareadelivery.distributorapp.ShopStaffHome.EditStaffSelf;
...
//    DeliveryGuySelf deliveryGuySelf = new DeliveryGuySelf();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.content_edit_shop_staff_self, container, false);
...
//            shopAdmin = getActivity().getIntent().getParcelableExtra(SHOP_ADMIN_INTENT_KEY);
            ...
            {
                staff = UtilityLogin.getShopStaff(getContext());
            }
...
//        final Staff staff = UtilityStaff.getStaff(getContext());
        Call<ResponseBody> call = staffService.updateBySelf(
...
//                    UtilityStaff.saveStaff(staff,getContext());
                    ...
                    UtilityLogin.saveShopStaff(staff,getActivity());
...
//                    UtilityShopStaff.saveStaff(staff,getContext());
