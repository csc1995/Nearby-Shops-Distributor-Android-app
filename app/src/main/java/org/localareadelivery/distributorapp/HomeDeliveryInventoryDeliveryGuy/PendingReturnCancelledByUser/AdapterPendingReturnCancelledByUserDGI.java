 ...
 */
class AdapterPendingReturnCancelledByUserDGI extends RecyclerView.Adapter<AdapterPendingReturnCancelledByUserDGI.ViewHolder>{
    ...
    AdapterPendingReturnCancelledByUserDGI(List<Order> dataset, NotifyAcceptReturn notifications) {
        this.dataset = dataset;
        this.notifications = notifications;
    }

    @Override
    public AdapterPendingReturnCancelledByUserDGI.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_item_pending_return_cancelled_by_user_dgi,parent,false);

        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(AdapterPendingReturnCancelledByUserDGI.ViewHolder holder, int position) {
