 ...
 */
public class AdapterPlacedOrders extends RecyclerView.Adapter<AdapterPlacedOrders.ViewHolder>{
    ...
    public AdapterPlacedOrders(List<Order> dataset, Context context, NotificationReciever notifications) {
