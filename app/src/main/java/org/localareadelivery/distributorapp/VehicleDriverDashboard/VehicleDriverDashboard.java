...
public class VehicleDriverDashboard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deliveryVehicleSelf = getIntent().getParcelableExtra(DELIVERY_VEHICLE_INTENT_KEY);
        mPagerAdapter = new PagerAdapter(getSupportFragmentManager(),deliveryVehicleSelf);
