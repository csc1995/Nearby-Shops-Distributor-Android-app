 ...
 */
class AdapterConfirmedPFS extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    AdapterConfirmedPFS(List<OrderPFS> dataset, NotifyConfirmOrder notifyConfirmOrder, Fragment fragment) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if(viewType==VIEW_TYPE_ORDER)
        {
            view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.list_item_order_confirmed_pfs,parent,false);
...
//        return -1;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holderVH, int position) {
        ...
        else if(holderVH instanceof LoadingViewHolder)
        {
            ...
            if(fragment instanceof ConfirmedOrdersFragmentPFS)
            {
                int items_count = ((ConfirmedOrdersFragmentPFS) fragment).item_count;
