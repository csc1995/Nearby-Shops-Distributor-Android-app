 ...
 */
class AdapterPendingDeliveryPFS extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    AdapterPendingDeliveryPFS(List<OrderPFS> dataset, NotifyConfirmOrder notifyConfirmOrder, Fragment fragment) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if(viewType==VIEW_TYPE_ORDER)
        {
            view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.list_item_order_delivery_pending_pfs,parent,false);
...
//        return -1;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holderVH, int position) {
        ...
        else if(holderVH instanceof LoadingViewHolder)
        {
            ...
            if(fragment instanceof PendingDeliveryFragmentPFS)
            {
                int items_count = ((PendingDeliveryFragmentPFS) fragment).item_count;
