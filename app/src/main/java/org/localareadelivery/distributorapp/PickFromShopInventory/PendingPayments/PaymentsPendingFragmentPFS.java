package org.localareadelivery.distributorapp.PickFromShopInventory.PendingPayments;
...
public class PaymentsPendingFragmentPFS extends Fragment implements AdapterPaymentsPendingPFS.NotifyConfirmOrder, SwipeRefreshLayout.OnRefreshListener ,NotifySort,NotifySearch,RefreshFragment{
...
//    OrderService orderService;
    ...
    AdapterPaymentsPendingPFS adapter;
    ...
    public PaymentsPendingFragmentPFS() {
    ...
    public static PaymentsPendingFragmentPFS newInstance() {
        PaymentsPendingFragmentPFS fragment = new PaymentsPendingFragmentPFS();
    ...
    void setupRecyclerView()
    {
        ...
        adapter = new AdapterPaymentsPendingPFS(dataset,this,this);
    ...
    void notifyTitleChanged()
    {
        ...
        if(getActivity() instanceof NotifyTitleChanged)
        {
            ((NotifyTitleChanged)getActivity())
                    .NotifyTitleChanged(
                            "Payments Pending (" + String.valueOf(dataset.size())
