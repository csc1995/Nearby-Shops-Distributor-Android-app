package org.localareadelivery.distributorapp.PickFromShopInventory.Placed;
...
public class PlacedOrdersFragmentPFS extends Fragment implements AdapterPlacedPFS.NotifyConfirmOrder, SwipeRefreshLayout.OnRefreshListener ,NotifySort,NotifySearch{
...
//    OrderService orderService;
    ...
    public PlacedOrdersFragmentPFS() {
    ...
    public static PlacedOrdersFragmentPFS newInstance() {
        PlacedOrdersFragmentPFS fragment = new PlacedOrdersFragmentPFS();
    ...
    void setupRecyclerView()
    {
        ...
        adapter = new AdapterPlacedPFS(dataset,this,this);
...
//            Shop currentShop = UtilityShopHome.getShop(getContext());
        ...
        Call<OrderEndPointPFS> call = orderServiceShopStaff.getOrdersPFS(
                    ...
                    null,null,
                    OrderStatusPickFromShop.ORDER_PLACED,
                    null,null,
                    null,null,
                    null, searchQuery,
