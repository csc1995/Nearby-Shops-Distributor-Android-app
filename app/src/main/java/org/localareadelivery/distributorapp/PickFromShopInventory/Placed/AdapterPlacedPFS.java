 ...
 */
class AdapterPlacedPFS extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    AdapterPlacedPFS(List<OrderPFS> dataset, NotifyConfirmOrder notifyConfirmOrder, Fragment fragment) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if(viewType==VIEW_TYPE_ORDER)
        {
            view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.list_item_order_placed_pfs,parent,false);
...
//        return -1;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holderVH, int position) {
        ...
        else if(holderVH instanceof LoadingViewHolder)
        {
            ...
            if(fragment instanceof PlacedOrdersFragmentPFS)
            {
                int items_count = ((PlacedOrdersFragmentPFS) fragment).item_count;
...
//        TextView confirmOrderButton;
    ...
    interface NotifyConfirmOrder{
        ...
        void notifyConfirmOrder(OrderPFS order,int position);
