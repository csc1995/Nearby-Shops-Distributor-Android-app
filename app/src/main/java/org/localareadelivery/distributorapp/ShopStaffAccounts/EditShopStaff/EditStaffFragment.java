package org.localareadelivery.distributorapp.ShopStaffAccounts.EditShopStaff;
...
import org.localareadelivery.distributorapp.ShopStaffAccounts.UtilityShopStaff;
...
//    DeliveryGuySelf deliveryGuySelf = new DeliveryGuySelf();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.content_edit_shop_staff, container, false);
...
//            shopAdmin = getActivity().getIntent().getParcelableExtra(SHOP_ADMIN_INTENT_KEY);
            ...
            {
                staff = UtilityShopStaff.getShopStaff(getContext());
            }
...
//        EditText user = (EditText) rootView.findViewById(R.id.username);
    ...
    void loadImage(String imagePath) {
        ...
        String iamgepath = UtilityGeneral.getServiceURL(getContext()) + "/api/v1/ShopStaff/Image/" + imagePath;
...
//    @OnTextChanged(R.id.username)
    ...
    void bindDataToViews()
    {
        if(staff!=null) {
            ...
            permitHandoverToDelivery.setChecked(staff.isHandoverToDelivery());
...
//        }
        ...
        // permissions General
        staff.setAddRemoveItemsFromShop(permitAddRemoveItems.isChecked());
        staff.setUpdateStock(permitUpdateStock.isChecked());

        // permissions home delivery
        staff.setCancelOrders(permitCancelOrders.isChecked());
        staff.setConfirmOrders(permitConfirmOrders.isChecked());
        staff.setSetOrdersPacked(permitSetOrdersPacked.isChecked());
        staff.setHandoverToDelivery(permitHandoverToDelivery.isChecked());
...
//        final Staff staff = UtilityStaff.getStaff(getContext());
        Call<ResponseBody> call = staffService.putShopStaff(
    ...
    void retrofitPOSTRequest()
    {
        ...
        Call<ShopStaff> call = staffService.postShopStaff(
                UtilityLogin.getAuthorizationHeaders(getContext()),
                staff);
