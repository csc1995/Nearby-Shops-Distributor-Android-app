...
import org.localareadelivery.distributorapp.ShopStaffAccounts.EditShopStaff.EditStaff;
import org.localareadelivery.distributorapp.ShopStaffAccounts.EditShopStaff.EditStaffFragment;

public class ShopStaffAccounts extends AppCompatActivity implements NotifyTitleChanged{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shop_staff_accounts);
...
//                        .setAction("Action", null).show();
                ...
                Intent intent = new Intent(ShopStaffAccounts.this, EditStaff.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_shop_staff_accounts, menu);
        return true;
    }
